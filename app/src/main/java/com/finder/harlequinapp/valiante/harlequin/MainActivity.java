...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHarleeFont = (TextView)findViewById(R.id.harleeFont);
        mymainLogo = (ImageView) findViewById(R.id.mainLogo);
        mAuth = FirebaseAuth.getInstance();

        //codice per settare font e logo
        Typeface myCustomFont = Typeface.createFromAsset(getAssets(),"fonts/Steinerlight.ttf");
        mHarleeFont.setTypeface(myCustomFont);
        mdescriptionText.setTypeface(myCustomFont);
        mymainLogo.setImageResource(R.drawable.logo);
